...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51Mg9cPSHdMO9nCqZIPfkdOFHxf24zZa6z4Rm9r5vhXyjC8N9CztFMThCGzDteR2cD5SxjbyOo49s04R7YQiHoS2600MyiiVbcu').
      then(stripe => {
        this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    ...
    if (!result) throw new Error('Problem attempting paymentwith stripe');
    return result;
  }
  ...
  private async createOrder(basket: Basket | null) {
    ...
    return firstValueFrom(this.checkoutService.createOder(orderToCreate));
  }
